...
{ std::cout << this << ": df cons" << std::endl; }//default constructor
...
#ifndef ncpp11
template <size_t init_size, size_t inc_bit>
inline core_string<init_size, inc_bit>::core_string(_Self && s):
...
{
	std::cout << this << ": cp_char cons" << std::endl;
	__len = strlen(s);
...
{
	std::cout << this << ": copy assign" << std::endl;
...
template <size_t init_size, size_t inc_bit>
inline core_string<init_size, inc_bit> &
	core_string<init_size, inc_bit>::operator=(_Self && s)
{
	std::cout << this << ": move assign" << std::endl;
...
{
	std::cout << this << ": cp_char assign" << std::endl;
