...
class BFSVISITOR : public BFSVisitor<adjacency_matrix_directed<> >
{
	typedef adjacency_matrix_directed<> graph_type;
...
class DFSVISITOR : public DFSVisitor<adjacency_matrix_directed<> >
{
	typedef adjacency_matrix_directed<> graph_type;
	typedef typename graph_type::size_type size_type;
public:
