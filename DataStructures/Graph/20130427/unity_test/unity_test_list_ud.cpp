...
class BFSVISITOR : public BFSVisitor<adjacency_list_undirected<> >
{
	typedef adjacency_list_undirected<> graph_type;
	typedef typename adjacency_list_undirected<>::size_type size_type;
public:
...
class DFSVISITOR : public DFSVisitor<adjacency_list_undirected<> >
{
	typedef adjacency_list_undirected<> graph_type;
	typedef typename adjacency_list_undirected<>::size_type size_type;
public:
